...
[@Vijay6923](https://github.com/Vijay6923) — via a direct message
through the contact method listed on that GitHub profile, or by
opening an issue titled only "Code of Conduct report" (with no
incident details in the issue itself) requesting a private channel to
report through. All complaints will be reviewed and investigated
promptly and fairly.
